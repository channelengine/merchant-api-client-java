...
public class MerchantOrderLineResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, isFulfillmentByMarketplace, merchantProductNo, gtin, description, unitVat, lineTotalInclVat, lineVat, originalUnitPriceInclVat, originalUnitVat, originalLineTotalInclVat, originalLineVat, originalFeeFixed, bundleProductMerchantProductNo, extraData, channelProductNo, quantity, cancellationRequestedQuantity, unitPriceInclVat, feeFixed, feeRate, condition, expectedDeliveryDate);
  }
