...
public class ShipmentApi {
     ...
     * @param fromDate Filter on the shipment date, starting from this date. This date is inclusive. (optional)
     * @param toDate Filter on the shipment date, until this date. This date is exclusive. (optional)
     ...
     */
    public okhttp3.Call shipmentIndexCall(List<String> merchantShipmentNos, List<String> merchantOrderNos, String method, List<String> shippedFromCountryCodes, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call shipmentIndexValidateBeforeCall(List<String> merchantShipmentNos, List<String> merchantOrderNos, String method, List<String> shippedFromCountryCodes, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = shipmentIndexCall(merchantShipmentNos, merchantOrderNos, method, shippedFromCountryCodes, fromDate, toDate, page, _callback);
        return localVarCall;
     ...
     */
    public CollectionOfMerchantShipmentResponse shipmentIndex(List<String> merchantShipmentNos, List<String> merchantOrderNos, String method, List<String> shippedFromCountryCodes, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page) throws ApiException {
        ApiResponse<CollectionOfMerchantShipmentResponse> localVarResp = shipmentIndexWithHttpInfo(merchantShipmentNos, merchantOrderNos, method, shippedFromCountryCodes, fromDate, toDate, page);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionOfMerchantShipmentResponse> shipmentIndexWithHttpInfo(List<String> merchantShipmentNos, List<String> merchantOrderNos, String method, List<String> shippedFromCountryCodes, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page) throws ApiException {
        okhttp3.Call localVarCall = shipmentIndexValidateBeforeCall(merchantShipmentNos, merchantOrderNos, method, shippedFromCountryCodes, fromDate, toDate, page, null);
     ...
     */
    public okhttp3.Call shipmentIndexAsync(List<String> merchantShipmentNos, List<String> merchantOrderNos, String method, List<String> shippedFromCountryCodes, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback<CollectionOfMerchantShipmentResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = shipmentIndexValidateBeforeCall(merchantShipmentNos, merchantOrderNos, method, shippedFromCountryCodes, fromDate, toDate, page, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantShipmentResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
