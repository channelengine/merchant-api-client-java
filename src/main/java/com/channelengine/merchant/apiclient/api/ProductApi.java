...
public class ProductApi {
     ...
     * @param operation 1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call productBulkPatchCall(List<Operation> operation, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call productBulkPatchValidateBeforeCall(List<Operation> operation, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = productBulkPatchCall(operation, _callback);
        return localVarCall;
     ...
     */
    public SingleOfProductCreationResult productBulkPatch(List<Operation> operation) throws ApiException {
        ApiResponse<SingleOfProductCreationResult> localVarResp = productBulkPatchWithHttpInfo(operation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SingleOfProductCreationResult> productBulkPatchWithHttpInfo(List<Operation> operation) throws ApiException {
        okhttp3.Call localVarCall = productBulkPatchValidateBeforeCall(operation, null);
     ...
     */
    public okhttp3.Call productBulkPatchAsync(List<Operation> operation, final ApiCallback<SingleOfProductCreationResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = productBulkPatchValidateBeforeCall(operation, _callback);
        Type localVarReturnType = new TypeToken<SingleOfProductCreationResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
