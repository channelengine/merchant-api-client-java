...
public class OrderApi {
     ...
     */
    public okhttp3.Call orderGetByFilterCall(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, Integer page, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call orderGetByFilterValidateBeforeCall(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = orderGetByFilterCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, page, _callback);
        return localVarCall;
     ...
     */
    public CollectionOfMerchantOrderResponse orderGetByFilter(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, Integer page) throws ApiException {
        ApiResponse<CollectionOfMerchantOrderResponse> localVarResp = orderGetByFilterWithHttpInfo(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, page);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionOfMerchantOrderResponse> orderGetByFilterWithHttpInfo(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, Integer page) throws ApiException {
        okhttp3.Call localVarCall = orderGetByFilterValidateBeforeCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, page, null);
     ...
     */
    public okhttp3.Call orderGetByFilterAsync(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, Integer page, final ApiCallback<CollectionOfMerchantOrderResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = orderGetByFilterValidateBeforeCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, page, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantOrderResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
