...
public class OrderApi {
     ...
     * @param toCreatedAtDate Filter on the created at date in ChannelEngine, until this date. This date is exclusive.&lt;br /&gt;The created date is set on the date and time when the order is created. (optional)
     ...
     * @param channelIds Filter orders on channel(s). (optional)
    ...
    public okhttp3.Call orderGetByFilterCall(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, OffsetDateTime fromCreatedAtDate, OffsetDateTime toCreatedAtDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, List<Integer> channelIds, List<Integer> stockLocationIds, Integer page, final ApiCallback _callback) throws ApiException {
        ...
        if (toCreatedAtDate != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("toCreatedAtDate", toCreatedAtDate));
        }
    ...
    private okhttp3.Call orderGetByFilterValidateBeforeCall(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, OffsetDateTime fromCreatedAtDate, OffsetDateTime toCreatedAtDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, List<Integer> channelIds, List<Integer> stockLocationIds, Integer page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = orderGetByFilterCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, fromCreatedAtDate, toCreatedAtDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, channelIds, stockLocationIds, page, _callback);
        return localVarCall;
    ...
    public ApiResponse<CollectionOfMerchantOrderResponse> orderGetByFilterWithHttpInfo(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, OffsetDateTime fromCreatedAtDate, OffsetDateTime toCreatedAtDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, List<Integer> channelIds, List<Integer> stockLocationIds, Integer page) throws ApiException {
        okhttp3.Call localVarCall = orderGetByFilterValidateBeforeCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, fromCreatedAtDate, toCreatedAtDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, channelIds, stockLocationIds, page, null);
     ...
     */
    public okhttp3.Call orderGetByFilterAsync(List<OrderStatusView> statuses, List<String> emailAddresses, List<String> merchantOrderNos, List<String> channelOrderNos, OffsetDateTime fromDate, OffsetDateTime toDate, OffsetDateTime fromCreatedAtDate, OffsetDateTime toCreatedAtDate, Boolean excludeMarketplaceFulfilledOrdersAndLines, FulfillmentType fulfillmentType, Boolean onlyWithCancellationRequests, List<Integer> channelIds, List<Integer> stockLocationIds, Integer page, final ApiCallback<CollectionOfMerchantOrderResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = orderGetByFilterValidateBeforeCall(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, fromCreatedAtDate, toCreatedAtDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, channelIds, stockLocationIds, page, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantOrderResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call orderGetNewCall(Integer stockLocationId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call orderGetNewValidateBeforeCall(Integer stockLocationId, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = orderGetNewCall(stockLocationId, _callback);
        return localVarCall;
     ...
     */
    public CollectionOfMerchantOrderResponse orderGetNew(Integer stockLocationId) throws ApiException {
        ApiResponse<CollectionOfMerchantOrderResponse> localVarResp = orderGetNewWithHttpInfo(stockLocationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionOfMerchantOrderResponse> orderGetNewWithHttpInfo(Integer stockLocationId) throws ApiException {
        okhttp3.Call localVarCall = orderGetNewValidateBeforeCall(stockLocationId, null);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantOrderResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call orderGetNewAsync(Integer stockLocationId, final ApiCallback<CollectionOfMerchantOrderResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = orderGetNewValidateBeforeCall(stockLocationId, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantOrderResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
