...
public class ReturnApi {
     ...
     */
    public okhttp3.Call returnGetDeclaredByChannelCall(List<String> merchantOrderNos, OffsetDateTime createdSince, List<ReturnStatus> statuses, List<ReturnReason> reasons, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call returnGetDeclaredByChannelValidateBeforeCall(List<String> merchantOrderNos, OffsetDateTime createdSince, List<ReturnStatus> statuses, List<ReturnReason> reasons, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = returnGetDeclaredByChannelCall(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page, _callback);
        return localVarCall;
     ...
     */
    public CollectionOfMerchantReturnResponse returnGetDeclaredByChannel(List<String> merchantOrderNos, OffsetDateTime createdSince, List<ReturnStatus> statuses, List<ReturnReason> reasons, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page) throws ApiException {
        ApiResponse<CollectionOfMerchantReturnResponse> localVarResp = returnGetDeclaredByChannelWithHttpInfo(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionOfMerchantReturnResponse> returnGetDeclaredByChannelWithHttpInfo(List<String> merchantOrderNos, OffsetDateTime createdSince, List<ReturnStatus> statuses, List<ReturnReason> reasons, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page) throws ApiException {
        okhttp3.Call localVarCall = returnGetDeclaredByChannelValidateBeforeCall(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page, null);
     ...
     */
    public okhttp3.Call returnGetDeclaredByChannelAsync(List<String> merchantOrderNos, OffsetDateTime createdSince, List<ReturnStatus> statuses, List<ReturnReason> reasons, OffsetDateTime fromDate, OffsetDateTime toDate, Integer page, final ApiCallback<CollectionOfMerchantReturnResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = returnGetDeclaredByChannelValidateBeforeCall(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfMerchantReturnResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
