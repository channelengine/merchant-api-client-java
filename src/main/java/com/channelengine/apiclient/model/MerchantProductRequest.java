...
public class MerchantProductRequest {
  ...
  **/
  @ApiModelProperty(example = "null", value = "A unique identifier of the product.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "If this product is a different version of another  product (for example, all fields are the same except  size and/or color), then this field should contain  the 'MerchantProductNo' of the parent. The parent  should already exist (or be present between the products  in the content of the API call, it does not matter whether   the parent is behind the child in the list).")
