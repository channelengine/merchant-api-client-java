...
public class ChannelProductResponse {
  ...
  private Map<String, String> mappedFields = new HashMap<String, String>();
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "An unique identifier which ChannelEngine uses to identify the product.  Needed in the call 'POST /v2/products/data'")
  ...
  **/
   ...
   * @return mappedFields
  **/
  @ApiModelProperty(example = "null", value = "A channel can require certain fields to be available. The channel  can provide ChannelEngine with this fields after which the merchants  will be able to fill in this field using custom conditions in ChannelEngine.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentChannelProductNo, mappedFields, name, description, brand, size, color, ean, manufacturerProductNumber, stock, price, MSRP, purchasePrice, vatRateType, shippingCost, shippingTime, url, imageUrl, categoryTrail, extraData);
  }
