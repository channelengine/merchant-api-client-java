...
public class OfferApi {
    ...
    private com.squareup.okhttp.Call offerStockPriceUpdateCall(List<MerchantStockPriceUpdateRequest> updates, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = updates;
        
        // create path and map variables
        String localVarPath = "/v2/offer".replaceAll("\\{format\\}","json");
