...
public class ReturnApi {
    ...
    private com.squareup.okhttp.Call returnDeclareForChannelCall(ChannelReturnRequest model, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = model;
        
        // create path and map variables
        String localVarPath = "/v2/returns/channel".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call returnDeclareForMerchantCall(MerchantReturnRequest model, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = model;
        
        // create path and map variables
        String localVarPath = "/v2/returns/merchant".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call returnGetDeclaredByChannelCall(DateTime createdSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call returnGetDeclaredByChannelValidateBeforeCall(DateTime createdSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CollectionOfMerchantReturnResponse returnGetDeclaredByChannel(DateTime createdSince) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CollectionOfMerchantReturnResponse> returnGetDeclaredByChannelWithHttpInfo(DateTime createdSince) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call returnGetDeclaredByChannelAsync(DateTime createdSince, final ApiCallback<CollectionOfMerchantReturnResponse> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call returnGetDeclaredByMerchantCall(DateTime createdSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call returnGetDeclaredByMerchantValidateBeforeCall(DateTime createdSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CollectionOfChannelReturnResponse returnGetDeclaredByMerchant(DateTime createdSince) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CollectionOfChannelReturnResponse> returnGetDeclaredByMerchantWithHttpInfo(DateTime createdSince) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call returnGetDeclaredByMerchantAsync(DateTime createdSince, final ApiCallback<CollectionOfChannelReturnResponse> callback) throws ApiException {
