...
public class ProductApi {
    ...
    private com.squareup.okhttp.Call productAcknowledgeDataChangesCall(ChannelProcessedChangesRequest changes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = changes;
        
        // create path and map variables
        String localVarPath = "/v2/products/data".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call productAcknowledgeOfferChangesCall(List<String> changes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = changes;
        
        // create path and map variables
        String localVarPath = "/v2/products/offers".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call productCreateCall(List<MerchantProductRequest> products, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    /**
     * Merchant: Create Product (asynchronously)
     * For merchants.    Create a product. The parent serves as the &#39;base&#39; product of the children.  For example, the children could be different sizes or colors of the parent product.  For channels where every size and color are different products this does not make any difference  (the children will just be sent separately, while ignoring the parent).  But there are channels where the parent and the children need to be sent together, for example  when there is one product with a list of sizes. In this case all the product information is retrieved  from the parent product while the size list is generated from the children.    Note that the parent itself is a &#39;blueprint&#39; of the child products and we do our best to make sure it  does not end up on the marketplaces itself. Only the children can be purchased.    It&#39;s not possible to nest parent and children more than one level (A parent can have many children,  but any child cannot itself also have children).    The supplied MerchantProductNo needs to be unique.
     * @param products  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private com.squareup.okhttp.Call productDeleteCall(String merchantProductNo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/v2/products/{merchantProductNo}".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call productGetByMerchantProductNoCall(String merchantProductNo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/v2/products/merchant/{merchantProductNo}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "merchantProductNo" + "\\}", apiClient.escapeString(merchantProductNo.toString()));
    ...
    private com.squareup.okhttp.Call productGetDataChangesCall(Integer maxCount, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call productGetOfferChangesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
